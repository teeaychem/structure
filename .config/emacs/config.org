...
(use-package auctex-latexmk
  ...
  (add-to-list 'TeX-command-list '("View" "%V"
								                   ...
								                   :help "Run Viewer"))
  (add-to-list 'TeX-command-list '("Biber" "biber %(output-dir) %s" TeX-run-Biber nil (plain-TeX-mode LaTeX-mode)
								                   :help "Run Biber"))
...
#+begin_src emacs-lisp
(add-to-list 'load-path (concat user-emacs-directory "../../projects/emacs/clingo-ts-mode/"))

(use-package clingo-ts-mode
  :mode "\\.lp'\\"
  :load-path (lambda() (concat user-emacs-directory "../../projects/emacs/clingo-ts-mode/")))
#+end_src
...
(with-eval-after-load 'eglot
  ...
  (add-to-list 'eglot-server-programs '(python-ts-mode . ("pylsp"))) ;; https://github.com/python-lsp/python-lsp-server
  )
#+END_Src
