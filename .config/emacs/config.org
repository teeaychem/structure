...
(tool-bar-mode -1) ;; disable the toolbar, nil doesn't work?
...
#+RESULTS:
| tempel-setup-capf | highlight-indent-guides-mode | rainbow-delimiters-mode | flyspell-prog-mode | flymake-mode |
