...
mouseSideButtons = hs.eventtap.new({ hs.eventtap.event.types.otherMouseDown }, function(e)
...
eisuuD = hs.eventtap.new({ hs.eventtap.event.types.keyDown }, function(e)
      print(e:getKeyCodec)
...
eisuuU = hs.eventtap.new({ hs.eventtap.event.types.keyUp }, function(e)
      if e:getKeyCode() == 102 then
         eisuuFlag = false
      end
end
