...
function obj:init()
  ...
  self.lastModifiers = {}
  self.cancel_delay_seconds = 0.150 -- If `control` is held for this long, don't send `escape`

  self.controlKeyTimer = hs.timer.delayed.new(self.cancel_delay_seconds, function()
    self.sendEscape = false
  end)
