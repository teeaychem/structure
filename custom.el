(custom-set-variables
 ...
 '(org-latex-preview-ltxpng-directory "/Users/sparkes/Documents/OrgTemp/")
 '(org-list-allow-alphabetical t)
 '(package-selected-packages
   (quote
    (leuven-theme zenburn-theme fzf cyberpunk-theme dracula-theme company-tern doom-themes xref-js2 js2-refactor js2-mode elpy magit smartparens yasnippet bind-key diminish powerline rich-minority s popwin popup epl pkg-info nlinum math-symbol-lists async color-theme dash company helm-core buffer-move wrap-region which-key px helm-company helm tabbar smooth-scrolling redo+ aggressive-indent smart-mode-line-powerline-theme use-package goto-chg exec-path-from-shell smart-mode-line multiple-cursors browse-kill-ring deft cdlatex rainbow-delimiters guide-key company-math flycheck company-auctex auctex-latexmk auctex)))
