...
- [[#packages-etc][packages, etc.]]
  ...
  - [[#yasnippet][yasnippet]]
- [[#org-mode][org mode]]
  - [[#background-org-stuff][background org stuff]]
- [[#languages][languages]]
  - [[#latex][LaTeX]]
  - [[#lisp][lisp]]
  - [[#python][python]]
...
(use-package tex
  ...
  :custom
  (TeX-PDF-mode t)
  (TeX-master "master") ; All master files called "master".
  (TeX-auto-save t)
  (TeX-save-query nil)
  (TeX-parse-self t)
...
Note: rust-analyzer requires more than a .rs file.
...
(use-package lsp-mode
  ...
  :commands
  (lsp lsp-deferred make-lsp-client lsp-register-client)
  :hook
...
Notes on a bug with projectile: https://github.com/bbatsov/projectile/issues/1387
