...
;;   :vc (:fetcher github :repo hasu/emacs-ob-racket)
;;   :after org
;;   :config
...
;;                    :rev :newest)
;;   :config
;;   (when (featurep 'lsp-mode) (lsp-snippet-tempel-lsp-mode-init)) ;; Initialize lsp-snippet -> tempel in lsp-mode
;;   (when (featurep 'eglot) (lsp-snippet-tempel-eglot-init)) ;; Initialize lsp-snippet -> tempel in eglot
;;   (lsp-snippet-tempel-lsp-mode-init))

;; ;; to ensure lsp-mode attempts completions see: https://github.com/svaante/lsp-snippet/issues/6
;; (defun yas-minor-mode () 'nil)
#+end_src
...
#+begin_src emacs-lisp
(use-package eglot
    :vc (eglot :url "https://elpa.gnu.org/devel/eglot.html"
               :rev :newest)
  :init
...
(use-package lsp-mode
  ...
  :hook (((rust-mode rust-ts-mode) . lsp)
  ...
  ;;        ("C-c l r a" . lsp-execute-code-action))
  :custom-face
  (lsp-face-highlight-textual ((t (:bold t
                                    :italic t
                                    :underline t
                                    :background nil))))
  :commands lsp)
