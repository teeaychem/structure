...
#+begin_src emacs-lisp :result silent
  (use-package flymake
    ...
    :bind (:map flymake-mode-map
                ...
                ("C-c e r e" . (lambda (&optional N INTERACTIVE)
                               (interactive (list 1 t))
                               (flymake-goto-next-error N '(error) INTERACTIVE)))
                ("C-c e r a" . (lambda (&optional N INTERACTIVE)
                               (interactive (list 1 t))
...
(use-package apheleia
  ...
  (setf (alist-get 'clang-format apheleia-formatters) '("clang-format" "-style=llvm" "-assume-filename"
  ...
  :bind
  (("C-c f a" . apheleia-format-buffer)))
#+end_src
...
(use-package flycheck
  ...
  :bind (:map flycheck-mode-map
              ("C-c e a" . flycheck-prev-error)
              ("C-c e e" . flycheck-next-error))
...
(use-package lsp-mode
  ...
  (add-to-list 'lsp-disabled-clients 'semgrep)
  ...
  :hook (((rust-mode
         ...
         ((rust-mode
           rust-ts-mode
           c++-mode
           c++-ts-mode) . (lambda () (setq-local lsp-inlay-hint-enable t)))
